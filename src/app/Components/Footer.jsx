...
export default function Footer() {
    ...
    return(
        <div className="flex flex-col justify-center items-center mb-25">
            ...
            <div className="flex flex-col pt-2 pb-4 pl-8 pr-8 border-1 border-[#35393c] rounded-4xl ">
                <h2 className="text-[#ffffff] mb-2 text-2xl md:text-3xl text-center">Our Socials</h2>
                <div className="flex flex-row gap-5 text-2xl md:text-3xl bg-gray-500/20 pt-2 pb-2 pl-6 pr-6 rounded-xl ">
