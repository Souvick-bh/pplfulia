...
export default function Members() {
    ...
    return(
        <div className={`${vt323.className} bg-[#000000] text-[#ffffff] min-h-screen flex flex-col  justify-center pr-8 pl-8`}>
            <Link href="/">
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <img className='absolute ' src={member.avatar_url || undefined} />
                    ...
                    <div className='flex flex-row w-60 justify-between items-center'>
                      ...
                      <div className="flex items-center gap-2">
                        <div className={`flex items-center gap-1 text-lg ${getRoleColor(member.role)}`}>
                  ...
                  {user && user.id !== member.user_id && (
                    ...
                    >
                      <Heart 
                        className={`h-4 w-4 ${member.is_liked_by_user ? 'fill-current' : ''}`} 
                      />
                    </button>
                  )}
                </div>
