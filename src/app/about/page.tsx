            ...
            <div className=" relative ml-35 mr-15 sm:ml-50">
                ...
                <div>
                    ...
                    <div className="text-2xl lg:text-3xl mt-10 ">What started as a friendly neighborhood tournament quickly turned
                        into an annual festival of chaos, charisma, and cricket. We’ve had:
                    ...
                    <div className="text-2xl lg:text-3xl mt-10 ">And guess what? We’re not just still going — we’re growing! This year marks our <span className="text-[#ea5e00]">6th Season</span>,
                ...
                <div className="text-3xl lg:text-4xl mt-20 ">
                    We’re now building this website to preserve those memories, honor those classic moments, and give our beloved league the stage it deserves. Because one day, we’ll look back at this and say:
                    <span className="text-[#ea5e00]">"Remember when we thought we were IPL stars?"</span>
                </div>

                <div className="text-3xl lg:text-4xl mt-20 mb-30">
                    Browse through old photos, match reports, bloopers, and the drama that only true PPL fans understand. Whether you're one of us or just here to laugh at us —
